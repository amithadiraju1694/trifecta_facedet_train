...
class AggregatePositionalEncoding(nn.Module):
    """
    ...
    def __init__(self, distance_metric='euclidean', aggregate_method='norm'):
        ...
        """
        super(AggregatePositionalEncoding, self).__init__()
...
class DecompPositionalEncoding(nn.Module):
    """
    ...
    def __init__(self,
        ...
        super(DecompPositionalEncoding, self).__init__()
...
class ViTWithAggPositionalEncoding(nn.Module):
    def __init__(self,
        ...
        # norm is L2 Norm
        self.custom_pos_encoding = AggregatePositionalEncoding(
    ...
    def forward(self, pixel_values):
        ...
        pos_encoded = patch_emb_output + ViT_stat_pos_emb + self.alpha * custom_pos_encodings # (batch_size, seq_len+1, hidden_size)
...
class ViTWithDecompPositionalEncoding(nn.Module):
    def __init__(self,
                 pretrained_model_name="google/vit-base-patch16-224",
        ...
        # norm is L2 Norm
        self.custom_pos_encoding = DecompPositionalEncoding(
    ...
    def forward(self, pixel_values):
        ...
        # Add both positional encodings
        pos_encoded = patch_emb_output + (1 - self.alpha) * ViT_stat_pos_emb + self.alpha * custom_pos_encodings # (batch_size, seq_len+1, hidden_size)
